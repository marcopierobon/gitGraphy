    ...
    if (
      ...
      if (
        ...
        vscode.window.showInformationMessage(
          "You have multiple workspaces open, " +
      ...
      var workspaceForOpenFile = vscode.workspace.getWorkspaceFolder(
        vscode.window.activeTextEditor.document.uri
      );

      if (workspaceForOpenFile === undefined) {
        vscode.window.showInformationMessage(
          "Could not determine the right namespace for the current tab. " +
